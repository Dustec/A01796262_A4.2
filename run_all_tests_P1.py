"""
Script para ejecutar todos los casos de prueba del programa P1.
...
def run_test_case(test_number):
    ...
    Args:
        test_number (int): Número del test case (1-7)

    Returns:
        tuple: (success, elapsed_time, output)
    """
    input_file = f"tests/P1/TC{test_number}.txt"
    output_file = f"results/P1/TC{test_number}_results.txt"
...
def generate_consolidated_report(results):
    ...
    """
    consolidated_file = "results/P1/StatisticsResults.txt"

    try:
        with open(consolidated_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("REPORTE CONSOLIDADO - PROGRAMA P1: computeStatistics.py\n")
...
def main():
    """Función principal."""
    print("=" * 80)
    print("EJECUTOR DE PRUEBAS - PROGRAMA P1: computeStatistics.py")
    print("=" * 80)
    ...
    # Ejecutar todos los test cases (TC1 a TC7)
    for i in range(1, 8):
